...
public class Palette {
    ...
    public static final Palette camineetPalette = new Palette(new int[]{
    ...
    public static final Palette gothicPalette = new Palette(new int[]{
    ...
    public static final Palette scionPalette = new Palette(new int[]{
    ...
    public static final Palette paseoPalette = new Palette(new int[]{
    ...
    public static final Palette skureSurfacePalette = new Palette(new int[]{
    ...
    public static final Palette skurePalette = new Palette(new int[]{
    ...
    public static final Palette airCastlePalette = new Palette(new int[]{
    ...
    public static final Palette palmaPalette = new Palette(new int[]{
    ...
    public static final Palette motaviaPalette = new Palette(new int[]{
            0x08, 0x00, 0x3F, 0x01, 0x03, 0x0B, 0x0F, 0x2F, 0x06, 0x38, 0x3C, 0x25, 0x2A, 0x04, 0x30, 0x0C,
            0x2F, 0x00, 0x3F, 0x2B, 0x0B, 0x2F, 0x37, 0x0F, 0x38, 0x34, 0x06, 0x01, 0x2A, 0x25, 0x3F, 0x00
    });
    public static final Palette dezorisPalette = new Palette(new int[]{
