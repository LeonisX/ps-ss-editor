...
import md.leonis.extractor.ExtractorApp;
import md.leonis.ps.editor.MainApp;
...
public class JavaFxUtils {
    ...
    public static void showMainPane(Stage primaryStage) {
        ...
        try {
            ...
            loader.setLocation(ExtractorApp.class.getResource(Config.resourcePath + "MainStage.fxml"));
    ...
    public static void showPane(String resource) {
        try {
            FXMLLoader loader = new FXMLLoader();
            loader.setLocation(ExtractorApp.class.getResource(Config.resourcePath + resource));
